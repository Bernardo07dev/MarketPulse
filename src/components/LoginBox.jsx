const LoginBox = () => {
    return(
        <div className="text-white w-[70%] p-12 pt-10 pb-14 bg-[#9797970f] backdrop-blur-2xl border border-white/10 rounded-2xl shadow-xl shadow-black flex flex-col items-center">
            ...
            <h1 className="text-3xl font-bold text-gray-200 text-center mb-1">Bem vindo de volta</h1>
            <p className=" text-sm text-gray-400 font-medium mb-4 text-center">Digite seus dados e faça login na platforma</p>
